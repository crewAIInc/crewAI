...
class NodeRenderer {
  ...
  render({ ctx, id, x, y }) {
    ...
    return {
      drawNode: () => {
        ctx.save();
        this.applyShadow(ctx, node);
        this.drawNodeShape(ctx, x, y, width, height, scale, nodeStyle);
  ...
  drawNodeShape(ctx, x, y, width, height, scale, nodeStyle) {
    ...
    const nodeColor = this.resolveCSSVariable(nodeStyle.bgColor);
    ...
    ctx.strokeStyle = this.resolveCSSVariable(nodeStyle.borderColor);
  ...
  drawNodeText(ctx, x, y, scale, nodeStyle) {
    ...
    ctx.fillStyle = this.resolveCSSVariable(nodeStyle.fontColor);
