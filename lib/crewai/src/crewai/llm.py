...
# Re-exported from the canonical context_window module for backwards compat.
from crewai.llms.context_window import (  # noqa: E402
    CONTEXT_WINDOW_USAGE_RATIO as _CWR,
    DEFAULT_CONTEXT_WINDOW_SIZE as _DCWS,
    LLM_CONTEXT_WINDOW_SIZES as _LLM_CWS,
)


LLM_CONTEXT_WINDOW_SIZES: Final[dict[str, int]] = _LLM_CWS
DEFAULT_CONTEXT_WINDOW_SIZE: Final[int] = _DCWS
CONTEXT_WINDOW_USAGE_RATIO: Final[float] = _CWR
...
class LLM(BaseLLM):
    ...
    def get_context_window_size(self) -> int:
        """
        Returns the context window size, using the shared resolver to look
        up the model and apply the usage ratio.
        ...
        from crewai.llms.context_window import resolve_context_window_size
