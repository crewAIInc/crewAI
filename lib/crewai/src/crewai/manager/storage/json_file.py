"""JSON file storage implementation for CrewManager."""
...
class JSONFileStorage(InMemoryStorage):
    """JSON file storage backend for persistent storage.
    ...
    def _load(self) -> None:
        ...
        try:
            ...
            raise RuntimeError(f"Failed to load JSON file: {e}") from e
