...
class ActionGate:
    ...
    # Default tool classification heuristics
    ...
    def evaluate(
        ...
        # 3. WRITE_IDEMPOTENT & WRITE_MUTATING: Allowed if token provided or fallback to simulation
        ...
        # 4. DESTRUCTIVE: Hard deny without valid prove token
