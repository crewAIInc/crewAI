...
@pytest.fixture
def mock_client_returns_mock_sandbox_in_create_sandbox(mock_sandbox, mock_sandbox_client):
...
@pytest.fixture
def ephemeral_mode_lifecycle_manager(request, mock_client_settings, sample_sandbox_settings):
...
@pytest.fixture
def persistent_mode_lifecycle_manager(request, mock_client_settings, sample_sandbox_settings):
    request.getfixturevalue("mock_client_returns_mock_sandbox_in_create_sandbox")
    request.getfixturevalue("mock_client_returns_mock_sandbox_in_get_sandbox")
