...
server_params=StdioServerParameters(
    command="python3", # Or your uvx executable i.e. "uvx"
    args=["mock_server.py"],
    env={"UV_PYTHON": "3.12", **os.environ},
)

with MCPServerAdapter(server_params=server_params) as tools:
...
server_params=StdioServerParameters(url="http://localhost:8000/sse")
