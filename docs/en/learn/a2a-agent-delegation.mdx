...
<Tabs>
  <Tab title="Bearer Token">
    ```python Code
from crewai.a2a.auth.schemas import BearerTokenAuth
from crewai.a2a.config import A2AConfig
...
agent = Agent(
  ...
  <Tab title="API Key">
    ```python Code
from crewai.a2a.auth.schemas import APIKeyAuth
from crewai.a2a.config import A2AConfig
...
agent = Agent(
  ...
  <Tab title="OAuth2">
    ```python Code
from crewai.a2a.auth.schemas import OAuth2ClientCredentials
from crewai.a2a.config import A2AConfig
...
agent = Agent(
  ...
  <Tab title="HTTP Basic">
    ```python Code
from crewai.a2a.auth.schemas import HTTPBasicAuth
from crewai.a2a.config import A2AConfig
