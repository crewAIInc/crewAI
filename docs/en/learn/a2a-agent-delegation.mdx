...
<Warning>
  `crewai.a2a.config.A2AConfig` is deprecated and will be removed in v2.0.0. Use `A2AClientConfig` for connecting to remote agents or `A2AServerConfig` for exposing agents as servers.
</Warning>
