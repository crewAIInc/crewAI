...
CrewAI connects to LLMs through native SDK integrations for the most popular providers (OpenAI, Anthropic, Google Gemini, Azure, AWS Bedrock, and Avian), and uses LiteLLM as a flexible fallback for all other providers.
