...
<Tabs>
    <Tab title="Using Environment Variables">
        ...
        # Example using AI Badgr (Budget/Utility, OpenAI-compatible)
        os.environ["OPENAI_API_KEY"] = "your-aibadgr-api-key"
        os.environ["OPENAI_API_BASE"] = "https://aibadgr.com/api/v1"
        os.environ["OPENAI_MODEL_NAME"] = "openai/premium"  # Use tier-based names: basic, normal, or premium
        ```
        </CodeGroup>
    </Tab>
    <Tab title="Using LLM Class Attributes">
        <CodeGroup>
            ...
            # Example using AI Badgr (Budget/Utility, OpenAI-compatible)
            llm = LLM(
                model="openai/premium",  # Use tier-based names: basic, normal, or premium
