...
When building custom tools that connect to external or untrusted data sources, it's highly recommended to use the [SIGIL Protocol](https://sigil-protocol.org) to prevent prompt injection and data exfiltration.
