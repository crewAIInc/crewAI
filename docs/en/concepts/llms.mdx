...
<AccordionGroup>
  ...
  <Accordion title="OpenRouter">
    [OpenRouter](https://openrouter.ai) provides unified access to 300+ models from OpenAI, Anthropic, Google, Meta, and other providers through a single API.
    ...
    **Basic Usage:**
    ...
    # Use any model with the openrouter/ prefix
    llm = LLM(
    ...
    **Popular Models:**
    ...
    | Model                                    | Context Window | Best For                          |
    |------------------------------------------|----------------|-----------------------------------|
    | openrouter/anthropic/claude-sonnet-4     | 200K tokens    | Complex reasoning, coding         |
    | openrouter/anthropic/claude-3.5-sonnet   | 200K tokens    | Balanced performance              |
    | openrouter/openai/gpt-4o                 | 128K tokens    | General purpose, multimodal       |
    | openrouter/google/gemini-2.0-flash       | 1M tokens      | Fast, large context               |
    | openrouter/meta-llama/llama-3.3-70b      | 128K tokens    | Open source, cost-effective       |
    | openrouter/deepseek/deepseek-chat-v3     | 64K tokens     | Efficient, code-focused           |
