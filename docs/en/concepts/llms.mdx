...
<AccordionGroup>
  ...
  <Accordion title="AI Badgr (Budget/Utility, OpenAI-compatible)">
    ...
    **Environment Variables:**
    ...
    Since AI Badgr is OpenAI-compatible, use the standard OpenAI environment variables:
    ```toml Code
    ...
    **Supported Environment Variables:**
    ...
    - `OPENAI_API_BASE`: Base URL (set to `https://aibadgr.com/api/v1`)
    - `OPENAI_MODEL_NAME`: Model to use (recommended: `openai/premium`)
    ...
    **Advanced Model Names:**
    ...
    For power users, AI Badgr may support additional model names. Refer to AI Badgr's documentation for the complete list of supported models and their tier mappings.
