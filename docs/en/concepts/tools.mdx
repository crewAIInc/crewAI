...
| **ProxiesSxProxyTool**           | A tool that routes Proxies.sx mobile proxy MCP actions like get_proxy and rotate_ip.           |
| **ProxiesSxBrowserTool**         | A tool that routes Proxies.sx browser MCP actions for stealth browser automation workflows.     |
