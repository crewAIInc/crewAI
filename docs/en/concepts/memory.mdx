...
[crewai-soul](https://github.com/menonpg/crewai-soul) stores memories in human-readable markdown files (`SOUL.md` + `MEMORY.md`) that you can edit and version-control with git.

**When to use:**
- You need to read/audit what your agents remember
- Memory should be tracked in git alongside code
- You want to manually edit memories when needed
- You prefer file-based storage over databases
