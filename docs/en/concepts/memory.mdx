...
2. **External Memory** - Standalone external memory providers (new approach)
...
| Feature | Basic Memory | External Memory |
|---------|-------------|----------------|
| **Setup Complexity** | Simple | Medium |
| **Integration** | Built-in contextual | Standalone |
| **Storage** | Local files | Custom/Mem0 |
| **Cross-session** | ✅| ✅ |
| **User-specific** | ❌ | ✅ |
| **Custom providers** | Limited | Any provider |
| **Recommended for** | Most use cases | Specialized needs |
