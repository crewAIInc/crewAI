...
crew = Crew(
    ...
    embedder={
        ...
        "config": {
            ...
            "model": "voyage-3.5"  # Latest general-purpose model
        }
    }
)
...
- `voyage-3.5` (Recommended): Latest general-purpose model with high performance
...
- `voyage-2`: Earlier general-purpose model
...
- `voyage-large-2-instruct`: Instruction-tuned embeddings
