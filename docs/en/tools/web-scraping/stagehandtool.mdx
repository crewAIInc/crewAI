...
To enable Browserbase session options such as verified browsers, proxies, or region selection, pass them through `browserbase_session_create_params`:
...
- Join Stagehand's [Discord community](https://stagehand.dev/discord)
