...
<CardGroup cols={2}>
  ...
  <Card title="Proxies.sx MCP Tools" icon="tower-broadcast" href="/en/tools/web-scraping/proxiessxtool">
    Real 4G/5G mobile proxies and stealth browser actions through Proxies.sx MCP servers.
  </Card>
...
- **Mobile IP + Stealth**: Use `ProxiesSxProxyTool` and `ProxiesSxBrowserTool` for mobile carrier proxy workflows
