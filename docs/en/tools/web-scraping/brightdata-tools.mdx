...
Sign up at [Bright Data](https://brightdata.com/?utm_source=tech-partner&utm_medium=link&utm_campaign=crewai&hs_signup=1) and retrieve your API key from your account settings. Set the `BRIGHT_DATA_API_KEY` environment variable with your actual API key.
