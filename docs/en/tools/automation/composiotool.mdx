...
3. Authenticating user manually

Composio automatically authenticates the user based on the session. However, you can also authenticate the user manually by calling the `authorize` method.
```python Code
