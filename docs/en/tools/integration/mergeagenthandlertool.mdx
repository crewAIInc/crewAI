...
1. **Sign up** for a Merge Agent Handler account at [merge.dev/agent-handler](https://merge.dev/agent-handler)
...
Visit the [Merge Agent Handler documentation](https://docs.merge.dev/agent-handler/) for a complete list of available integrations.
