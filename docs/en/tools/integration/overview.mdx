...
<CardGroup cols={2}>
  <Card title="Fía Signals Tools" icon="chart-line" href="/en/tools/integration/fiasignalstools">
    Add crypto market regime detection, technical trading signals, and DeFi yield intelligence through `fia-signals-tools`.
  </Card>
