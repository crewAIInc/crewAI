...
<CardGroup cols={2}>
  ...
  <Card title="x402search Tool" icon="magnifying-glass-dollar" href="/en/tools/search-research/x402searchtool">
    Search 14,000+ x402-enabled API services by capability. $0.01 USDC per query, no API key needed.
  </Card>
</CardGroup>
