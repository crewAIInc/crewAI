...
<CardGroup cols={2}>
  ...
  <Card title="Airweave Search Tool" icon="magnifying-glass" href="/en/tools/search-research/airweavesearchtool">
    AI-powered search for data living across all of your organization's apps.
  </Card>
...
agent = Agent(
    ...
    tools=[airweave_search, web_search, code_search, video_research, tavily_search, content_extractor],
