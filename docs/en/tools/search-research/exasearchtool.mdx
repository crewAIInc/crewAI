...
description: "Search the web using the Exa web search API, one of the best web search APIs for AI, to find the most relevant results for any query, with options for full page content, highlights, and summaries."
