...
<CardGroup cols={2}>
  ...
  <Card title="GoldRush Blockchain Tools" icon="link" href="/en/tools/database-data/goldrushtools">
    Access multichain blockchain data from 100+ networks — wallets, transactions, NFTs, DEX prices, and more via MCP.
  </Card>
</CardGroup>
