...
<CardGroup cols={2}>
  ...
  <Card title="SochDB Vector Search" icon="vector-square" href="/en/tools/database-data/sochdbvectorsearchtool">
    Search remote SochDB collections over gRPC using semantic similarity.
  </Card>
