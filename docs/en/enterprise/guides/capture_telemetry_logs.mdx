...
3. Select an integration:
   - **OpenTelemetry Traces** or **OpenTelemetry Logs** — export to any OTLP-compatible collector or backend.
...
<Tabs>
  ...
  <Tab title="Datadog">
    - **Datadog Site Domain** — Your Datadog site's OTLP domain only — for example `otlp.us5.datadoghq.com` — with no protocol or path. CrewAI builds the full HTTPS OTLP endpoint for you. Use the domain that matches your [Datadog site](https://docs.datadoghq.com/getting_started/site/).
