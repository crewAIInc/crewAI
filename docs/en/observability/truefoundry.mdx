...
TrueFoundry provides an enterprise-ready [AI Gateway](https://www.truefoundry.com/ai-gateway) that can be used for governance and observability for agentic frameworks like CrewAI. TrueFoundry AI Gateway serves as a unified interface for LLM access, providing:
...
## [Tracing](https://docs.truefoundry.com/docs/tracing/tracing-getting-started)
