...
an event handler implemented on top of OpenTelemetry (OTel).
...
Add the following code at the top of your main.py file to import
...
Under the hood, this integration is built on OpenTelemetry (OTel)
for standardized tracing and telemetry collection.

### Register the event listener

At the beginning of your run() function (or before starting the Crew),
instantiate the Galileo event listener:
