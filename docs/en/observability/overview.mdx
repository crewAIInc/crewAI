...
<CardGroup cols={2}>
  <Card title="Vaultak" icon="shield-halved" href="/en/observability/vaultak">
    Runtime security monitoring — risk-score every tool call, enforce policies, mask PII, and block dangerous actions before they execute.
  </Card>
</CardGroup>
