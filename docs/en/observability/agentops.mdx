...
[![AgentOps Integration Tutorial](https://raw.githubusercontent.com/AgentOps-AI/agentops/refs/heads/main/docs/images/youtube-play-thumbnail.png)](https://youtu.be/t9YRRd2-wus)
...
#### Session Metrics
![Overview of a select series of agent session runs](https://raw.githubusercontent.com/AgentOps-AI/agentops/refs/heads/main/docs/images/overview.png)

#### Session Replays
![Overview of session drilldowns for examining agent runs](https://raw.githubusercontent.com/AgentOps-AI/agentops/refs/heads/main/docs/images/session-waterfall.png)

#### Execution Graphs
![Viewing a step-by-step agent replay execution graph](https://raw.githubusercontent.com/AgentOps-AI/agentops/refs/heads/main/docs/images/session-graph.png)
...
<Steps>
   ...
   <Step title="Initialize AgentOps">
      ...
      check out the [AgentOps documentation](https://docs.agentops.ai) or join the [Discord](https://discord.gg/FagdcwwXRR).
   </Step>
</Steps>
...
<span>&nbsp;&nbsp;•&nbsp;&nbsp;</span>
<a href="https://docs.agentops.ai">📙 Documentation</a>
