...
|---------|-------------|-----|----------------|
| Anthropic API | Organization acts as processor | Cloud API; Anthropic processes prompts on your behalf | DPA required (Article 28) |
| OpenAI API | Organization acts as processor | Cloud API; same as above | DPA required |
| Google GenAI | Organization acts as processor | Cloud API | DPA required |
| AWS Bedrock | Organization acts as processor | Managed inference; AWS processes on your behalf | DPA via AWS agreement |
| GCP Vertex AI | Organization acts as processor | Managed inference | DPA via GCP agreement |
| Pinecone / Qdrant Cloud | Organization acts as processor | Cloud-hosted vector storage | DPA required |
...
| AWS S3 | Organization acts as processor | Cloud storage | DPA via AWS agreement |
