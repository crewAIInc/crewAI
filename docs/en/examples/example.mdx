...
<CardGroup cols={2}>
  <Card title="CrewAI - Crew Orbit" icon="sparkles" href="https://agentavatar.dev/#/gallery">
    Community-made generative visual identity for CrewAI on agentavatar.dev. Find it in the gallery as "CrewAI - Crew Orbit".
  </Card>
  <Card title="Submit Agent Avatar" icon="pen" href="https://agentavatar.dev/#/agent">
    Submit updates or publish an official draw_fn version for CrewAI using the open agent visual identity protocol.
  </Card>
</CardGroup>
