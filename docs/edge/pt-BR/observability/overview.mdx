...
<CardGroup cols={2}>
  ...
  <Card title="OrcaReplay" icon="rotate-left" href="/pt-BR/observability/orcareplay">
    Grave uma execução em arquivo e reproduza-a offline, byte a byte, sem mudar o código.
  </Card>
</CardGroup>
