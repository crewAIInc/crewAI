...
<CardGroup cols={2}>
  ...
  <Card title="Agent Action Capsule" icon="file-shield" href="/pt-BR/observability/capsule-emit">
    Registros de evidência selados e verificáveis por terceiros para cada chamada de ferramenta em uma execução de crew.
  </Card>
