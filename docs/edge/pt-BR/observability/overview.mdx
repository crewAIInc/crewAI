...
<CardGroup cols={2}>
  ...
  <Card title="Confident AI" icon="shield-check" href="/pt-BR/observability/confident-ai">
    Rastreamento nativo em OpenTelemetry com online evals em cada kickoff de crew.
  </Card>
