...
| **PII detection applied** | `Yes` se houver configuração de PII por deployment ou uma [política de PII](/pt-BR/enterprise/features/agent-control-plane/policies) correspondente ativa. |
...
<CardGroup cols={2}>
  ...
  <Card title="Agent Control Plane — Políticas" icon="shield-check" href="/pt-BR/enterprise/features/agent-control-plane/policies">
