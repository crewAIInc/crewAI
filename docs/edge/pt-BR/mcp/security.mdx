...
Veja também [Design Seguro de Agentes](/edge/pt-BR/guides/agents/secure-agent-design) para limites de confiança, prompt injection, abuso de ferramentas, portões de aprovação e isolamento de agentes.
