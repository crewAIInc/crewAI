...
| Task `human_input` | Pausa para input no console no caminho da Task. |
...
Exija uma pessoa ou uma checagem de política externa antes de ações irreversíveis, caras ou públicas.
...
Aplique a aprovação em código. Não dependa só do prompt.
