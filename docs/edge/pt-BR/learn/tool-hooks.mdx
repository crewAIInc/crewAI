...
Decisões de recusa impedem a execução da ferramenta interna e retornam uma referência para a evidência de decisão assinada. Use `shadow_mode=True` no wrapper para observar decisões sem alterar o comportamento da execução.
