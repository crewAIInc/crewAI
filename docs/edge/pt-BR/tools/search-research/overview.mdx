...
<CardGroup cols={2}>
  ...
  <Card title="AnySearch Tool" icon="magnifying-glass" href="/pt-BR/tools/search-research/anysearchtool">
    Pesquisa na web que funciona sem chave de API, com autenticação opcional por chave.
  </Card>
