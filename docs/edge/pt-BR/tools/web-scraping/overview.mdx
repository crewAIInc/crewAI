...
<CardGroup cols={2}>
  ...
  <Card title="Zenrows Scrape Tool" icon="spider" href="/pt-BR/tools/web-scraping/zenrowsscrapetool">
    Bypass de anti-bot, renderização JS e rotação de proxies via Adaptive Stealth Mode do Zenrows.
  </Card>
</CardGroup>
