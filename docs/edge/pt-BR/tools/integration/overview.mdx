...
<CardGroup cols={2}>
  ...
  <Card title="Ferramentas de Memória de Agente Lians" icon="brain" href="/pt-BR/tools/integration/lians">
    Dê aos agentes CrewAI memória durável e com registro de tempo usando armazenamento local ou remoto.
  </Card>
</CardGroup>
