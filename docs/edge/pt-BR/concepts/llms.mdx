...
<AccordionGroup>
  ...
  <Accordion title="Nebius Serverless Endpoint (vLLM)">
    ...
    <Warning>
      O uso de ferramentas exige um modelo com suporte a tool calling e uma implantação vLLM configurada com o tool-call parser correspondente e automatic tool choice. Verifique essas opções para o seu modelo antes de usar ferramentas do CrewAI.
    </Warning>
