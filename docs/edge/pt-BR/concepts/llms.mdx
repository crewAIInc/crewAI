...
<AccordionGroup>
  ...
  <Accordion title="Cheaper Inference">
    [Cheaper Inference](https://cheaperinference.com) é um gateway de LLM compatível com a OpenAI. Ele oferece modelos de vários laboratórios com uma única chave de API.
    Cada modelo custa de 15–60% menos que o preço de tabela do seu laboratório.
    ...
    <Info>
      Modelos do Cheaper Inference (IDs de modelo sem prefixo):
    ...
    Consulte a [lista de modelos do Cheaper Inference](https://cheaperinference.com/#models) para os IDs de modelo atuais.
    Obtenha uma chave de API em [cheaperinference.com/signup](https://cheaperinference.com/signup).
  </Accordion>
</AccordionGroup>
