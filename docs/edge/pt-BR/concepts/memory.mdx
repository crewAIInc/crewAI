...
- **Memória Persistente Dakera**: Servidor de memória persistente em rede alimentado pelo pacote [`crewai-dakera`](https://pypi.org/project/crewai-dakera/) ([Repositório Fonte](https://github.com/Dakera-AI/dakera-crewai)). Gerencia o embedding de conteúdo e consultas no lado do servidor com busca híbrida vetor/BM25, eliminando a necessidade de um modelo de embedding local.
