...
Confira o [Guia de Implantação](https://docs-platform.crewai.com/platform/pt-BR/guides/deploy-to-amp) para começar.
...
Agentes com ferramentas podem executar ações reais. Veja [Design Seguro de Agentes](/edge/pt-BR/guides/agents/secure-agent-design) para limites de confiança, prompt injection, abuso de ferramentas, validação de saída, portões de aprovação, limites de delegação e isolamento de agentes.
...
- Aplique os controles de [Design Seguro de Agentes](/edge/pt-BR/guides/agents/secure-agent-design).
