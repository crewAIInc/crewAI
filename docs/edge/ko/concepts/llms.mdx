...
<AccordionGroup>
  ...
  <Accordion title="Cheaper Inference">
    [Cheaper Inference](https://cheaperinference.com)는 OpenAI 호환 LLM 게이트웨이입니다. 하나의 API 키로 여러 연구소의 모델을 제공합니다.
    각 모델은 해당 연구소의 정가보다 15–60% 저렴합니다.
    ...
    <Info>
      Cheaper Inference 모델 (접두사 없는 모델 ID):
    ...
    현재 모델 ID는 [Cheaper Inference 모델 목록](https://cheaperinference.com/#models)을 참조하십시오.
    API 키는 [cheaperinference.com/signup](https://cheaperinference.com/signup)에서 발급받을 수 있습니다.
  </Accordion>
</AccordionGroup>
