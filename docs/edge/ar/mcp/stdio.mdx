...
يوفر Entroly أدوات محلية لاختيار السياق واستعادته عبر stdio MCP. ثبّت
[`uv`](https://docs.astral.sh/uv/getting-started/installation/)، ثم اضبط المحول
لتشغيل إصدار Entroly الذي تم التحقق منه من دون تثبيت عام دائم:
...
قبل استخدامه في سير عمل، تحقق من الحزمة المثبتة ومسار الاستعادة المحلي من دون
مفتاح API:
...
يعتمد تقليل السياق وجودة المهام اللاحقة على حمل العمل والميزانية المحددة.
قِس المهام الممثلة قبل توجيه طلبات الإنتاج.
