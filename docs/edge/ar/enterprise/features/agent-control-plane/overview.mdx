...
<Info>
  **تنقل وثائق ACP (إصدار تجريبي)**
  ...
  - [السياسات](/ar/enterprise/features/agent-control-plane/policies)
</Info>
...
- **Policies** — *"كيف أفرض سياسة (مثل PII redaction) عبر العديد من عمليات النشر دون إعادة نشر كل واحدة؟"* راجع [السياسات](/ar/enterprise/features/agent-control-plane/policies).
...
<CardGroup cols={2}>
  ...
  <Card title="السياسات" icon="shield-check" href="/ar/enterprise/features/agent-control-plane/policies">
