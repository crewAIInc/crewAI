...
- **Dakera (ذاكرة دائمة مستضفة ذاتيًا)**: خادم ذاكرة دائمة قائم على الشبكة يدعم الذاكرة المشتركة بين الفرق، وعزل سياق الوكلاء المتعددين، والاسترجاع الموزون بالاضمحلال. قم بتثبيت `crewai-dakera` ومرّر `DakeraStorageBackend` إلى `Memory(storage=...)`.
...
**لماذا التخزين المستضاف ذاتيًا**: على عكس التخزين المحلي فقط في الملفات، تتيح خدمات الشبكة مثل Dakera للفرق المتعددة أو الوكلاء أو عقد العمل الموزعة المشاركة في مخزن ذاكرة متجهية دائم مركزي.
