...
- **ذاكرة Dakera الدائمة**: خادم ذاكرة دائمة قائم على الشبكة مدعوم بحزمة [`crewai-dakera`](https://pypi.org/project/crewai-dakera/) ([مستودع المصدر](https://github.com/Dakera-AI/dakera-crewai)). يتعامل مع تضمين المحتوى والاستعلام على جانب الخادم مع استرجاع هجين (متجه/BM25)، مما يلغي الحاجة إلى نموذج تضمين محلي.
...
**لماذا التخزين المستضاف ذاتيًا**: تتيح خدمات الشبكة مثل Dakera للفرق المتعددة أو الوكلاء أو عقد العمل الموزعة المشاركة في مخزن ذاكرة دائم مركزي (متجهات و BM25) دون الاعتماد فقط على التخزين المحلي للملفات.
