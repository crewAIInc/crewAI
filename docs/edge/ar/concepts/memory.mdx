...
- **ذاكرة Dakera الدائمة**: خادم ذاكرة دائمة قائم على الشبكة مدعوم بحزمة [`crewai-dakera`](https://pypi.org/project/crewai-dakera/) ([مستودع المصدر](https://github.com/Dakera-AI/dakera-crewai)). يتعامل مع تضمين المحتوى والاستعلامات على جانب الخادم مع استرجاع هجين (متجه/BM25)، مما يلغي الحاجة إلى نموذج تضمين محلي.
