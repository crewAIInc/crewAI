...
| **LLM** _(اختياري)_                    | `llm`                    | `Union[str, LLM, Any]`                | نموذج اللغة الذي يشغّل الوكيل. يستخدم أول متغير بيئة غير فارغ: `MODEL`، ثم `MODEL_NAME`، ثم `OPENAI_MODEL_NAME`؛ وإلا يستخدم `gpt-5.6-luna` افتراضيًا. |
...
- `llm`: نموذج اللغة الذي يشغّل الوكيل. يستخدم أول متغير بيئة غير فارغ: `MODEL`، ثم `MODEL_NAME`، ثم `OPENAI_MODEL_NAME`؛ وإلا يستخدم `gpt-5.6-luna` افتراضيًا.
