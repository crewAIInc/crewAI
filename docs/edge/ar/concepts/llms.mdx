...
<AccordionGroup>
  ...
  <Accordion title="Cheaper Inference">
    [Cheaper Inference](https://cheaperinference.com) هي بوابة LLM متوافقة مع OpenAI. توفر نماذج من عدة مختبرات عبر مفتاح API واحد.
    كل نموذج أرخص بنسبة 15–60% من سعر القائمة لدى مختبره.

    اضبط متغيرات البيئة التالية في ملف `.env`:
    ```toml Code
    # Required
    ...
    <Info>
      نماذج Cheaper Inference (معرّفات نماذج بدون بادئة):
    ...
    راجع [قائمة نماذج Cheaper Inference](https://cheaperinference.com/#models) لمعرّفات النماذج الحالية.
    احصل على مفتاح API من [cheaperinference.com/signup](https://cheaperinference.com/signup).
  </Accordion>
</AccordionGroup>
