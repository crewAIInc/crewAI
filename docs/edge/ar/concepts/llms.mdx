...
<AccordionGroup>
  ...
  <Accordion title="Nebius Serverless Endpoint (vLLM)">
    ...
    <Warning>
      يتطلب استخدام الأدوات نموذجًا يدعم tool calling ونشر vLLM مضبوطًا باستخدام محلل tool-call المطابق وخيار الأدوات التلقائي. تحقّق من هذه الخيارات لنموذجك قبل استخدام أدوات CrewAI.
    </Warning>
