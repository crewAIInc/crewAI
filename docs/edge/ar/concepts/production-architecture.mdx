...
يمكن للـ Agents المزودة بأدوات تنفيذ إجراءات حقيقية. راجع [تصميم Agent الآمن](/edge/ar/guides/agents/secure-agent-design) لحدود الثقة وحقن المطالبات وإساءة استخدام الأدوات والتحقق من المخرجات وبوابات الموافقة وحدود التفويض وعزل الـ Agents.
...
- طبّق عناصر التحكم في [تصميم Agent الآمن](/edge/ar/guides/agents/secure-agent-design).
