...
<CardGroup cols={2}>
  ...
  <Card title="Zenrows Scrape Tool" icon="spider" href="/ar/tools/web-scraping/zenrowsscrapetool">
    تجاوز أنظمة مكافحة البوتات، وتنفيذ JS، وتدوير البروكسي عبر Adaptive Stealth Mode من Zenrows.
  </Card>
</CardGroup>
