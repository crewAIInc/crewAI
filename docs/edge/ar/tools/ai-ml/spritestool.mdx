...
- يحدّد `timeout` مدة انتظار العميل؛ لكنه **لا** يضمن إنهاء العملية البعيدة. كذلك لا يضمن الإلغاء غير المتزامن إنهاءها. بعد انتهاء المهلة أو فشل الاتصال، افحص Sprite قبل إعادة أمر له آثار جانبية.
- يُقتطع الخرج **بعد** أن يلتقطه SDK. يحدّ ذلك من سياق الوكيل، لا من استهلاك الذاكرة. وجّه الخرج المطوّل إلى ملفات داخل Sprite.
