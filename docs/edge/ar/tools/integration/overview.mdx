...
<CardGroup cols={2}>
  ...
  <Card title="أدوات ذاكرة الوكيل من Lians" icon="brain" href="/ar/tools/integration/lians">
    امنح وكلاء CrewAI ذاكرة دائمة ومؤرخة زمنياً باستخدام تخزين محلي أو بعيد.
  </Card>
</CardGroup>
