...
<CardGroup cols={2}>
  ...
  <Card title="أداة بحث AnySearch" icon="magnifying-glass" href="/ar/tools/search-research/anysearchtool">
    بحث في الويب يعمل بدون مفتاح API، مع مصادقة اختيارية عبر مفتاح.
  </Card>
