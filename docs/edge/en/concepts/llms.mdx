...
<AccordionGroup>
  ...
  <Accordion title="Requesty">
    ...
    ```toml Code
    REQUESTY_API_KEY=***
    # Optional. Defaults to https://router.requesty.ai/v1.
    # Use https://router.eu.requesty.ai/v1 for the EU endpoint.
    ...
    <Info>
      ...
      The API key and base URL are read from `REQUESTY_API_KEY` and `REQUESTY_BASE_URL`.
      List available models with `GET https://router.requesty.ai/v1/models`.
      Examples:
