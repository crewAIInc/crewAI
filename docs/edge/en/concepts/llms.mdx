...
<AccordionGroup>
  ...
  <Accordion title="Crusoe">
    ...
    Available models include `zai/GLM-5.2`, `zai/GLM-5.1`, `moonshotai/Kimi-K2.6`, `deepseek-ai/DeepSeek-V4-Pro`, `deepseek-ai/Deepseek-V4-Flash`, `Qwen/Qwen3-235B-A22B-Instruct-2507`, `openai/gpt-oss-120b`, `nvidia/NVIDIA-Nemotron-3-Super-120B-A12B`, and `meta-llama/Llama-3.3-70B-Instruct` — see the [Crusoe Managed Inference docs](https://docs.crusoecloud.com/managed-inference/overview/index.html) for the full catalog.
