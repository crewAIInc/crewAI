...
<AccordionGroup>
  ...
  <Accordion title="Cheaper Inference">
    [Cheaper Inference](https://cheaperinference.com) is an OpenAI-compatible LLM gateway. It serves models from many labs through one API key.
    ...
    <Info>
      Cheaper Inference models (bare model ids):
    ...
    See the [Cheaper Inference model list](https://cheaperinference.com/#models) for current model ids.
