...
<CardGroup cols={2}>
  ...
  <Card title="OpenUI" icon="window-maximize" href="/edge/en/guides/frontend/openui">
    Stream model-authored charts, forms, and interactive responses through AG-UI.
  </Card>
...
<Tip>
This page follows the CopilotKit runtime path. If you want the model to compose the whole response from an interactive component library, [OpenUI](/edge/en/guides/frontend/openui) connects its `AgentInterface` directly to the same CrewAI AG-UI endpoint, without the intermediate CopilotKit runtime.
</Tip>
...
<CardGroup cols={2}>
  ...
  <Card title="OpenUI" icon="window-maximize" href="/edge/en/guides/frontend/openui">
    Let the model compose streaming charts, forms, and follow-up actions.
  </Card>
