...
<CardGroup cols={2}>
  ...
  <Card title="Agent Action Capsule" icon="file-shield" href="/en/observability/capsule-emit">
    Sealed, third-party-verifiable evidence records for every tool call in a crew run.
  </Card>
