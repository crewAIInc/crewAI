...
<CardGroup cols={2}>
  ...
  <Card title="Noveum Trace" icon="chart-line" href="/en/observability/noveum-trace">
    Community-maintained tracing and evaluation for crews, tasks, agents, LLM calls, and tools.
  </Card>
