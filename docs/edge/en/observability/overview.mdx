...
<CardGroup cols={2}>
  ...
  <Card title="DProvenanceKit" icon="code-compare" href="/en/observability/dprovenancekit">
    Records each kickoff as a diffable trace and fails CI when the crew's reasoning drifts from a golden baseline.
  </Card>
</CardGroup>
