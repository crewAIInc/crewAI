...
<CardGroup cols={2}>
  ...
  <Card title="The Context Company" icon="chart-line" href="/en/observability/the-context-company">
    AI agent observability and customer analytics for understanding and improving production crews.
  </Card>
