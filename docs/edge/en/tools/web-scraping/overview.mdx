...
<CardGroup cols={2}>
  ...
  <Card title="Zenrows Scrape Tool" icon="spider" href="/en/tools/web-scraping/zenrowsscrapetool">
    Anti-bot bypass, JS rendering, and proxy rotation via Zenrows' Adaptive Stealth Mode.
  </Card>
</CardGroup>
