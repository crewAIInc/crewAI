...
<CardGroup cols={2}>
  ...
  <Card title="NeuralVerge Tools" icon="building" href="/en/tools/search-research/neuralverge-tools">
    Company and person intelligence: reverse email and phone lookup, email finder, funding, LinkedIn and Amazon data.
  </Card>
</CardGroup>
