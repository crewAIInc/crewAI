...
<CardGroup cols={2}>
  ...
  <Card title="AnySearch Tool" icon="magnifying-glass" href="/en/tools/search-research/anysearchtool">
    Web search that works without an API key, with optional key-based authentication.
  </Card>
