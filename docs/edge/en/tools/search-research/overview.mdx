...
<CardGroup cols={2}>
  ...
  <Card title="iFlow Search Tools" icon="magnifying-glass" href="/en/tools/search-research/iflowsearchtools">
    Web search, image search, and web page fetching via the iFlow Search API.
  </Card>
