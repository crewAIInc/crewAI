...
<CardGroup cols={2}>
  ...
  <Card title="Cracked Tool Router" icon="plug" href="/en/tools/automation/crackedtool">
    Reach 60,000+ tools (search, scrapers, social, maps, finance, AI models) through one API key.
  </Card>
