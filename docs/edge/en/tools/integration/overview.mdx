...
<CardGroup cols={2}>
  ...
  <Card title="Lians Agent Memory Tools" icon="brain" href="/en/tools/integration/lians">
    Give CrewAI agents durable, timestamped memory with local or remote storage.
  </Card>
</CardGroup>
...
- **Plan for latency**: External automations may take longer, so set appropriate polling intervals and timeouts
