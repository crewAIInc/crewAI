...
See also [Secure Agent Design](/edge/en/guides/agents/secure-agent-design) for trust boundaries, prompt injection, tool abuse, approval gates, and agent isolation.
