...
<Steps>
  ...
  <Step title="배포 준비">
    ...
    ```
    구조와 요구 사항은 [준비 가이드](https://docs-platform.crewai.com/platform/ko/guides/prepare-for-deployment)를 참고하세요.
  </Step>
  <Step title="AMP에 배포">
    ...
    crewai deploy
    ```
    [GitHub 연동](https://docs-platform.crewai.com/platform/ko/guides/deploy-to-amp) 또는 [Crew Studio](https://docs-platform.crewai.com/platform/ko/guides/enable-crew-studio)로도 배포할 수 있습니다.
  </Step>
  <Step title="API로 접근">
...
<CardGroup cols={2}>
  <Card title="AMP에 배포" icon="rocket" href="https://docs-platform.crewai.com/platform/ko/guides/deploy-to-amp">
    전체 배포 가이드 — CLI, GitHub, Crew Studio 방법.
  </Card>
  <Card title="AMP 소개" icon="globe" href="https://docs-platform.crewai.com/platform/ko/introduction">
