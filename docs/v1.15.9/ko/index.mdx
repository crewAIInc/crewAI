...
<CardGroup cols={3}>
  <Card title="Automations" href="https://docs-platform.crewai.com/platform/ko/features/automations" icon="server">
    환경을 관리하고 안전하게 재배포하며, Enterprise 콘솔에서 실시간 실행을 모니터링하세요.
  </Card>
  <Card title="Triggers & Flows" href="https://docs-platform.crewai.com/platform/ko/guides/automation-triggers" icon="bolt">
    Gmail, Slack, Salesforce 등 다양한 서비스를 연결하고 trigger payload를 자동으로 크루와 플로우에 전달하세요.
  </Card>
  <Card title="팀 관리" href="https://docs-platform.crewai.com/platform/ko/guides/team-management" icon="users-gear">
...
<CardGroup cols={2}>
  <Card title="트리거 개요" href="https://docs-platform.crewai.com/platform/ko/guides/automation-triggers" icon="sparkles">
