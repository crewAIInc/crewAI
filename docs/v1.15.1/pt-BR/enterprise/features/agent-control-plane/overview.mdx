...
<Info>
  **Navegação da Documentação do ACP (Beta)**
  ...
  - [Políticas](/pt-BR/enterprise/features/agent-control-plane/policies)
</Info>
...
- **Políticas** — *"Como aplico uma política (por exemplo, PII redaction) em muitos deployments sem precisar reimplantar cada um?"* Veja [Políticas](/pt-BR/enterprise/features/agent-control-plane/policies).
...
<CardGroup cols={2}>
  ...
  <Card title="Políticas" icon="shield-check" href="/pt-BR/enterprise/features/agent-control-plane/policies">
