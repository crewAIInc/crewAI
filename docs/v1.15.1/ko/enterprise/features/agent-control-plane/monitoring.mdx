...
| **PII detection applied** | deployment별 PII 설정 또는 일치하는 [PII 정책](/ko/enterprise/features/agent-control-plane/policies)이 활성화된 경우 `Yes`. |
...
<CardGroup cols={2}>
  ...
  <Card title="Agent Control Plane — 정책" icon="shield-check" href="/ko/enterprise/features/agent-control-plane/policies">
