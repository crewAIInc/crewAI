...
| **PII detection applied** | `Yes` إذا كان هناك تكوين PII لكل deployment أو [سياسة PII](/ar/enterprise/features/agent-control-plane/policies) مطابِقة نشطة. |
...
<CardGroup cols={2}>
  ...
  <Card title="Agent Control Plane — السياسات" icon="shield-check" href="/ar/enterprise/features/agent-control-plane/policies">
