...
<CardGroup cols={2}>
  ...
  <Card title="Oxylabs Amazon Product Scraper Tool" icon="globe" href="/tools/web-scraping/oxylabsamazonproductscrapertool">
    Scrape Amazon Product data with Oxylabs.
  </Card>

  <Card title="Oxylabs Amazon Search Scraper Tool" icon="globe" href="/tools/web-scraping/oxylabsamazonsearchscrapertool">
    Scrape Amazon Search results with Oxylabs.
  </Card>

  <Card title="Oxylabs Amazon Product Scraper Tool" icon="globe" href="/tools/web-scraping/oxylabsgooglesearchscrapertool">
    Scrape Google Search results with Oxylabs.
  </Card>

  <Card title="Oxylabs Universal Scraper Tool" icon="globe" href="/tools/web-scraping/oxylabsuniversalscrapertool">
