...
يتبع هذا البرنامج التعليمي [البدء السريع مع CrewAI](/en/quickstart) ويوضح كيفية إضافة [CrewAIEventListener](https://v2docs.galileo.ai/sdk-api/python/reference/handlers/crewai/handler) من Galileo كمعالج أحداث.

> **ملاحظة** يفترض هذا البرنامج التعليمي أنك أكملت [البدء السريع مع CrewAI](/en/quickstart).
...
### الخطوة 2: أضف إلى ملف .env من [البدء السريع مع CrewAI](/en/quickstart)
