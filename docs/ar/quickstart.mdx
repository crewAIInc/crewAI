...
إذا لم تكن قد ثبّتها بعد، يمكنك القيام بذلك باتباع [دليل التثبيت](/en/installation).
...
<Steps>
  ...
  قبل تشغيل طاقمك، تأكد من تعيين المفاتيح التالية كمتغيرات بيئة في ملف `.env`:
    ...
    - إعداد النموذج الذي اخترته، مثل مفتاح API. راجع
        [دليل إعداد LLM](/en/concepts/llms#setting-up-your-llm) لمعرفة كيفية إعداد النماذج من أي مزود.
  </Step>
