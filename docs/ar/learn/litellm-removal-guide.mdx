...
- [اتصالات LLM](/en/learn/llm-connections) — الدليل الكامل لربط CrewAI مع أي LLM
- [مفاهيم LLM](/en/concepts/llms) — فهم نماذج اللغة الكبيرة في CrewAI
- [دليل اختيار LLM](/en/learn/llm-selection-guide) — اختيار النموذج المناسب لحالة استخدامك
