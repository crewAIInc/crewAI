...
- تعلم المزيد عن [صياغة Agents فعّالة](/en/guides/agents/crafting-effective-agents)
- استكشف [بناء أول Crew](/en/guides/crews/first-crew)
- تعمّق في [إتقان إدارة حالة Flow](/en/guides/flows/mastering-flow-state)
- اطلع على [المفاهيم الأساسية](/en/concepts/agents) لفهم أعمق
