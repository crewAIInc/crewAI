...
يتطور CrewAI بسرعة. الإصدارات الجديدة تقوم بانتظام بضبط مسارات الاستيراد وتغيير الإعدادات الافتراضية لـ `Agent` و`Crew` و`Task`. يجمع هذا الدليل الخطوات العملية اللازمة من أجل:
