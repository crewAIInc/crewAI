...
1. تثبيت CrewAI باتباع [دليل التثبيت](/en/installation)
2. إعداد مفتاح API لنموذج LLM في بيئتك، باتباع [دليل إعداد LLM](/en/concepts/llms#setting-up-your-llm)
...
راجع [دليل إعداد LLM](/en/concepts/llms#setting-up-your-llm) لتفاصيل تهيئة المزود المفضل لديك. يمكنك الحصول على مفتاح Serper API من [Serper.dev](https://serper.dev/).
...
5. استكشف [CrewAI Flows](/en/guides/flows/first-flow) لسير عمل أكثر تقدمًا مع البرمجة الإجرائية
