...
<CardGroup cols={2}>
  <Card title="مشروع جاهز للنشر" icon="check-circle">
    ...
    اتبع [دليل التحضير](/en/enterprise/guides/prepare-for-deployment) للتحقق من بنية مشروعك.
  </Card>
...
<Info>
  **الطواقم مقابل التدفقات**: يمكن نشر كلا نوعي المشاريع كـ "أتمتات" على CrewAI AMP.
  ...
  راجع [التحضير للنشر](/en/enterprise/guides/prepare-for-deployment) للتفاصيل.
</Info>
...
تحتاج لدفع طاقمك إلى مستودع GitHub. إذا لم تكن قد أنشأت طاقماً بعد، يمكنك [اتباع هذا الدليل](/en/quickstart).
  ...
  <Step title="تعيين متغيرات البيئة">
    ...
    <Info>
      ...
      راجع [سجلات الحزم الخاصة](/en/enterprise/guides/private-package-registry) للمتغيرات المطلوبة.
    </Info>
...
راجع [التحضير للنشر](/en/enterprise/guides/prepare-for-deployment) لمخططات البنية المفصلة.
