...
<Warning>
  ...
  ملف القفل مطلوب للنشر — راجع [التحضير للنشر](/en/enterprise/guides/prepare-for-deployment).
</Warning>
...
<Tabs>
  <Tab title="واجهة الويب">
    ...
    راجع خطوة [النشر على AMP — تعيين متغيرات البيئة](/en/enterprise/guides/deploy-to-amp#set-environment-variables) للتفاصيل.
  </Tab>
...
لتحديث بيانات الاعتماد في نشر حالي، راجع [تحديث طاقمك — متغيرات البيئة](/en/enterprise/guides/update-crew).
...
<CardGroup cols={3}>
  <Card title="التحضير للنشر" icon="clipboard-check" href="/en/enterprise/guides/prepare-for-deployment">
    تحقق من بنية المشروع والاعتماديات قبل النشر.
  </Card>
  <Card title="النشر على AMP" icon="rocket" href="/en/enterprise/guides/deploy-to-amp">
    انشر طاقمك أو تدفقك وهيّئ متغيرات البيئة.
  </Card>
  <Card title="تحديث طاقمك" icon="arrows-rotate" href="/en/enterprise/guides/update-crew">
