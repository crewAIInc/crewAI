...
<CardGroup cols={2}>
  <Card title="مشغل Gmail" icon="envelope">
    <a href="/en/enterprise/guides/gmail-trigger">فعّل الطواقم عند وصول رسائل بريد إلكتروني أو تحديث سلاسل المحادثات.</a>
  </Card>
...
<Card title="مشغل Slack" icon="slack">
  ...
  <Card title="مشغل Zapier" icon="bolt">
    <a href="/en/enterprise/guides/zapier-trigger">اربط CrewAI بآلاف التطبيقات المدعومة من Zapier.</a>
  </Card>
</CardGroup>
