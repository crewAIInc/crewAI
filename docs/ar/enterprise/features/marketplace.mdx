...
<CardGroup cols={3}>
  <Card title="الأدوات والتكاملات" href="/en/enterprise/features/tools-and-integrations" icon="wrench">
    اربط التطبيقات الخارجية وأدِر الأدوات الداخلية التي يمكن لوكلائك استخدامها.
  </Card>
  <Card title="مستودع الأدوات" href="/en/enterprise/guides/tool-repository#tool-repository" icon="toolbox">
    انشر وثبّت الأدوات لتعزيز قدرات طواقمك.
  </Card>
  <Card title="مستودع الوكلاء" href="/en/enterprise/features/agent-repositories" icon="people-group">
