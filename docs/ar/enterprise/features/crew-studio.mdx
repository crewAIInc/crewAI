...
<CardGroup cols={4}>
  <Card title="تفعيل استوديو الطاقم" href="/en/enterprise/guides/enable-crew-studio" icon="palette">
    تفعيل استوديو الطاقم.
  </Card>
  <Card title="بناء طاقم" href="/en/enterprise/guides/build-crew" icon="paintbrush">
    بناء طاقم.
  </Card>
  <Card title="نشر طاقم" href="/en/enterprise/guides/deploy-crew" icon="rocket">
    نشر طاقم من GitHub أو ملف ZIP.
  </Card>
  <Card title="تصدير مكون React" href="/en/enterprise/guides/react-component-export" icon="download">
    تصدير مكون React.
  </Card>
</CardGroup>
