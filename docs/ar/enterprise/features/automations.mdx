...
<CardGroup cols={3}>
  ...
  <Card title="مشغلات الأتمتة" href="/en/enterprise/guides/automation-triggers" icon="trigger">
    شغّل الأتمتة عبر webhooks أو API.
  </Card>
  <Card title="أتمتة Webhook" href="/en/enterprise/guides/webhook-automation" icon="webhook">
