...
للحصول على دليل كامل حول التغذية الراجعة البشرية في التدفقات، بما في ذلك **التغذية الراجعة غير المتزامنة/غير الحاجبة** مع مزودين مخصصين (Slack، webhooks، إلخ)، انظر [التغذية الراجعة البشرية في التدفقات](/en/learn/human-feedback-in-flows).
...
تعرّف على المزيد حول البث في دليل [بث تنفيذ التدفق](/en/learn/streaming-flow-execution).
