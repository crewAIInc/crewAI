...
بعد إنشاء مشروع CrewAI كما هو موضح في قسم [التثبيت](/en/installation)، انتقل إلى ملف `src/latest_ai_development/config/agents.yaml` وعدّل القالب ليتوافق مع متطلباتك.
