...
<AccordionGroup>
  <Accordion title="OpenAI">
    ...
    **معاملات Responses API:**
    ...
    <Tip>
      استخدم Responses API للمشاريع الجديدة، خاصة عند العمل مع نماذج الاستدلال (o1, o3, o4) أو عندما تحتاج دعمًا أصليًا متعدد الوسائط لـ [الملفات](/en/concepts/files).
    </Tip>
...
<Tabs>
  ...
  <Tab title="معالجة الأحداث">
    ...
    <Tip>
      [انقر هنا](/en/concepts/event-listener#event-listeners) لمزيد من التفاصيل
    </Tip>
  </Tab>
