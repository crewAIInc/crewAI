...
<Update label="31 jul 2026">
  ...
  [Ver release no GitHub](https://github.com/crewAIInc/crewAI/releases/tag/1.15.10)

  ## O que Mudou

  ### Funcionalidades
  - Coletar eventos de uso de habilidades

  ### Documentação
  - Remover documentação AMP migrada
  - Atualizar diretrizes de relatórios de segurança
  - Snapshot e changelog para v1.15.9
...
<Update label="25 mar 2026">
  ...
  [Ver release no GitHub](https://github.com/crewAIInc/crewAI/releases/tag/1.12.0a1)
  ...
  ### Documentação
  - Adicionar CONTRIBUTING.md
  - Adicionar guia para usar o CrewAI sem o LiteLLM
