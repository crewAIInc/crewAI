...
3. 통합을 선택합니다:
   - **OpenTelemetry Traces** 또는 **OpenTelemetry Logs** — OTLP 호환 수집기 또는 백엔드로 내보냅니다.
...
<Tabs>
  ...
  <Tab title="Datadog">
    - **Datadog Site Domain** — Datadog 사이트의 OTLP 도메인만 입력합니다 — 예: `otlp.us5.datadoghq.com` — 프로토콜이나 경로는 포함하지 않습니다. CrewAI가 전체 HTTPS OTLP 엔드포인트를 자동으로 구성합니다. [Datadog 사이트](https://docs.datadoghq.com/getting_started/site/)에 맞는 도메인을 사용하세요.
