...
O CrewAI evolui rapidamente. Novas versões frequentemente ajustam caminhos de import e alteram defaults de `Agent`, `Crew` e `Task`. Este guia reúne os passos práticos necessários para:
