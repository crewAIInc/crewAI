...
3. Selecione uma integração:
   - **OpenTelemetry Traces** ou **OpenTelemetry Logs** — exporte para qualquer coletor ou backend compatível com OTLP.
...
<Tabs>
  ...
  <Tab title="Datadog">
    - **Datadog Site Domain** — Apenas o domínio OTLP do seu site Datadog — por exemplo `otlp.us5.datadoghq.com` — sem protocolo ou caminho. O CrewAI monta o endpoint HTTPS OTLP completo para você. Use o domínio correspondente ao seu [site Datadog](https://docs.datadoghq.com/getting_started/site/).
