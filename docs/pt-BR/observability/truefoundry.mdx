...
TrueFoundry provides an enterprise-ready [AI Gateway](https://www.truefoundry.com/ai-gateway) for agentic frameworks like CrewAI. TrueFoundry AI Gateway serves as a unified interface for LLM access, providing:
...
2. Follow the steps [here](https://docs.truefoundry.com/gateway/quick-start) and generate a [Personal Access Token (PAT)](https://docs.truefoundry.com/docs/gateway/authentication)
...
This provides additional trace correlation across your entire CrewAI workflow. For more details see our [docs](https://docs.truefoundry.com/docs/tracing/overview)
