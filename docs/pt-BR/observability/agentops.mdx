...
[![Tutorial de Integração com AgentOps](https://raw.githubusercontent.com/AgentOps-AI/agentops/refs/heads/main/docs/images/youtube-play-thumbnail.png)](https://youtu.be/t9YRRd2-wus)
...
#### Métricas de Sessão
![Visão geral de uma série selecionada de execuções de sessões do agente](https://raw.githubusercontent.com/AgentOps-AI/agentops/refs/heads/main/docs/images/overview.png)

#### Replays de Sessão
![Visão geral das análises detalhadas de sessões para examinar execuções de agentes](https://raw.githubusercontent.com/AgentOps-AI/agentops/refs/heads/main/docs/images/session-waterfall.png)

#### Gráficos de Execução
![Visualizando um gráfico de execução passo a passo do replay do agente](https://raw.githubusercontent.com/AgentOps-AI/agentops/refs/heads/main/docs/images/session-graph.png)
...
<Steps>
   ...
   <Step title="Inicialize o AgentOps">
      ...
      confira a [documentação do AgentOps](https://docs.agentops.ai) ou participe do [Discord](https://discord.gg/FagdcwwXRR).
   </Step>
</Steps>
...
<span>&nbsp;&nbsp;•&nbsp;&nbsp;</span>
<a href="https://docs.agentops.ai">📙 Documentação</a>