...
- `instructions` (str, optional): Natural language instructions to guide the crawler.
...
- `extract_depth` (Literal["basic", "advanced"], optional): Extraction depth for page content.
