...
<CardGroup cols={2}>
  ...
  <Card title="Tavily Search Tool" icon="magnifying-glass" href="/pt-BR/tools/search-research/tavilysearchtool">
    Comprehensive web search using Tavily's AI-powered search API.
  </Card>

  <Card title="Tavily Extract Tool" icon="file-text" href="/pt-BR/tools/search-research/tavilyextractortool">
    Extract structured content from web pages using the Tavily API.
  </Card>

  <Card title="Tavily Crawl Tool" icon="spider" href="/pt-BR/tools/search-research/tavilycrawltool">
