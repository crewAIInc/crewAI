...
<CardGroup cols={2}>
  ...
  <Card title="Tavily Extract Tool" icon="file-text" href="/pt-BR/tools/search-research/tavilyextracttool">
    Extraia conteúdo estruturado de páginas da web usando a API Tavily.
  </Card>
</CardGroup>
