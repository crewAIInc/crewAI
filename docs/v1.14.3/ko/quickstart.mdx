...
<Tip>
  첫 배포는 보통 **약 1분** 정도 걸립니다. 전체 사전 요건과 웹 UI 절차는 [AMP에 배포](https://docs-platform.crewai.com/platform/ko/guides/deploy-to-amp)를 참고하세요.
</Tip>

<CardGroup cols={2}>
  <Card title="배포 가이드" icon="book" href="https://docs-platform.crewai.com/platform/ko/guides/deploy-to-amp">
