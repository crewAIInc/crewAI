...
<Tip>
    **LLM Model Recommendations for Manager Agents**
    ...
    - **Recommended**: More capable models like `GPT-4o` work well for manager agents and delegation
    - **Not Recommended**: Smaller models like `GPT-4o-mini` and `smaller local models` struggle with delegation
    
    For best results with hierarchical processes, use more powerful models for your `manager_llm`.
</Tip>
