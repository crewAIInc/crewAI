...
![Overview of a select series of agent session runs](https://github.com/crewAIInc/crewAI/blob/main/docs/images/agentops-overview.png)
![Overview of session drilldowns for examining agent runs](https://github.com/crewAIInc/crewAI/blob/main/docs/images/agentops-session.png)
![Viewing a step-by-step agent replay execution graph](https://github.com/crewAIInc/crewAI/blob/main/docs/images/agentops-replay.png)
