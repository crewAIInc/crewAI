...
<Tip>
  غالبًا ما يستغرق **النشر الأول حوالي دقيقة**. المتطلبات الكاملة ومسار الواجهة الويب في [النشر على AMP](https://docs-platform.crewai.com/platform/ar/guides/deploy-to-amp).
</Tip>

<CardGroup cols={2}>
  <Card title="دليل النشر" icon="book" href="https://docs-platform.crewai.com/platform/ar/guides/deploy-to-amp">
