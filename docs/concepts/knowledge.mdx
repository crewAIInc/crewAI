...
| `embedder_config`          | **Optional[Dict[str, Any]]**         | No       | Configuration for the embedding model used to convert content into vector representations. Supports various providers like OpenAI, Google, etc.        |
