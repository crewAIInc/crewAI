...
# Reseting the agent specific knowledge via crew object
crew.reset_memories(command_type = 'agent_knowledge')

# Reseting the agent specific knowledge via CLI
...
You can customize the API query by modifyinga the endpoint URL:
