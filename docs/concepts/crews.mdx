...
- `kickoff_for_each()`: Starts the execution process for each of the event given sequentially.
- `kickoff_async()`: Initiates the workflow asynchronously.
- `kickoff_for_each_async()`: Starts the execution process for each of the event in an parallelly / asynchronous manner.
