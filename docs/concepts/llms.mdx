...
<AccordionGroup>
  ...
  <Accordion title="Drop Additional Parameters">
    ...
    ```
    <Info>
      Link to the GitHub issue for more details:&nbsp;
      <a href="https://github.com/crewAIInc/crewAI/issues/2843" target="_blank" rel="noopener noreferrer">
        o3 is giving a stop message in crewai
      </a>
      <a href="https://github.com/crewAIInc/crewAI/issues/2661" target="_blank" rel="noopener noreferrer">
        o4-mini usage raising stop parameter not support exception
      </a>
    </Info>
  </Accordion>
</AccordionGroup>
