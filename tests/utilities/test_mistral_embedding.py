...
class TestMistralEmbeddingFunction:
    ...
    def test_model_info(self):
        ...
        embedding_func = MistralEmbeddingFunction(
            api_key="test_api_key", model_name="mistral-embed"
        )
    ...
    def test_retry_logic(self, mock_post):
        ...
        embedding_func = MistralEmbeddingFunction(api_key="test_api_key", max_retries=3)
    ...
    def test_configure_mistral_fallback_to_config_model(self):
        ...
        with patch.dict(os.environ, {"MISTRAL_API_KEY": "test_api_key"}):
            with patch(
                ...
                result = build_embedder(
                    {"provider": "mistral", "config": embedder_config["config"]}
                )
...
class TestErrorHandling:
    ...
    def test_invalid_provider_error(self):
        ...
        embedder_config = {"provider": "unsupported_provider", "config": {}}
    ...
    def test_missing_api_key_error(self):
        ...
        embedder_config = {"provider": "mistral", "config": {}}
...
def test_mistral_embedding_with_fixtures(
    mock_mistral_api_response, test_embedder_config
):
