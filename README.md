...
The first example using the ollama mistral model only three lines need to be changed to run locally!
...
#os.environ["OPENAI_API_KEY"] = "Your Key"
ollama = Ollama(model="mistral") ############### first change
