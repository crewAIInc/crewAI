...
CrewAI includes native support for [MiniMax](https://www.minimax.io) models. Set the `MINIMAX_API_KEY` environment variable and use `MiniMax-M2.5` or `MiniMax-M2.5-highspeed` as the model name:
