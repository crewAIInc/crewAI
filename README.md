...
CrewAI includes native support for [MiniMax](https://www.minimax.io) models. Set the `MINIMAX_API_KEY` environment variable and use `MiniMax-M3` (latest flagship) or any other available model as the model name:
