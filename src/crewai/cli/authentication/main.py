...
class AuthenticationCommand:
    ...
    def new_login(self) -> None:
        ...
        console.print(
            f"4. Done! You are now logged in.\n\n Welcome to CrewAI enterprise, [bold cyan]{user_name}[/bold cyan].",
            style="bold green",
        )
        return None
