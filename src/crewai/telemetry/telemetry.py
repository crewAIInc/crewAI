...
class Telemetry:
    ...
    def _safe_telemetry_operation(self, operation) -> None:
        if not self.ready:
            return
    ...
    def tool_usage(self, llm: Any, tool_name: str, attempts: int, agent: Any = None) -> None:
    ...
    def get_crew_logs_span(self, uuid: str | None, log_type: str = "deployment") -> None:
    ...
    def end_crew(self, crew, final_string_output) -> None:
        def operation() -> None:
            self._add_attribute(
    ...
    def _add_attribute(self, span, key, value) -> None:
