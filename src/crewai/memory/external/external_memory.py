...
if TYPE_CHECKING:
    ...
    from crewai.memory.storage.agentcore_storage import AgentCoreStorage
...
class ExternalMemory(Memory):
    ...
    @staticmethod
    def _configure_agentcore(crew: Any, config: Dict[str, Any]) -> "AgentCoreStorage":
        from crewai.memory.storage.agentcore_storage import AgentCoreStorage
        
        return AgentCoreStorage(type="external", crew=crew, config=config)
