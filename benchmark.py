...
def execute_tool(tool_name, tool_input):
    if tool_name == "read_file":
        ...
        base = tool_input.get("base_dir", "/src/totto/crewAI")
...
BASELINE_PROMPT = """You are a helpful assistant answering questions about the CrewAI framework.
The repository is at /src/totto/crewAI.
...
KCP_PROMPT = """You are a helpful assistant answering questions about the CrewAI framework.
The repository is at /src/totto/crewAI.
IMPORTANT: First read /src/totto/crewAI/knowledge.yaml to understand the repository structure.
